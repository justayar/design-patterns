...
public class SRPFriendlyClassExample {
    static class Data {
        String name;
        String value;
        Calendar date;
    ...
    static class Report {
        String name;
        List<SRPViolatedClassExample.Data> dataList;
        String preparedBy;
        Calendar date;

        public Report(String name, List<SRPViolatedClassExample.Data> dataList, String preparedBy, Calendar date) {
            this.name = name;
